...
export const SPECIES_OPTIONS = ['Human', 'Alien', 'Humanoid', 'Robot', 'Animal', 'Mythological Creature', 'Poopybutthole', 'Cronenberg', 'Disease'];

export const characterListUrl = (params) => `${BASE_URL}/character?${new URLSearchParams(params).toString()}`;
